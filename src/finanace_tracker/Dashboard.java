...
public class Dashboard extends javax.swing.JPanel {
   ...
   public Dashboard(String emailOG) {
    ...
    private void updateIncomeChart() {
        //List<ModelPieChart> incomeData = sqlite.getIncomeData(); //!sqlite
        List<ModelPieChart> incomeData = userAuthentication.getIncomeData(email);
    ...
    private void updateExpenseChart() {
      //  List<ModelPieChart> expenseData = sqlite.getExpenseData(); sqlite
        List<ModelPieChart> expenseData = userAuthentication.getExpenseData(email);
    ...
    private void updateValues() {
       // double totalIncome = getTotalIncome(); sqlite
        double totalIncome = UserAuthentication.getTotalIncome(email); //h2
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(income_label, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
